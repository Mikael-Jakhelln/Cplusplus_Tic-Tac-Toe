...
namespace game{
	...
	class game{
		...
		{//game runs in here, runs while anyonewonyet returns 0, also lets the controlling entity choose to play again
			...
			bot1.difficulty = 1; //bot difficulty default = easiest 
			bot::bot bot2 = bot::bot();
			bot2.difficulty = 2; //bot difficulty default = easiest 
			...
			//DEBUG
			cout << "bot1.playernumber: " << bot1.playernumber << endl;
			cout << "bot1.difficulty: " << bot1.difficulty << endl;
			cout << "bot2.playernumber: " << bot2.playernumber << endl;
			cout << "bot2.difficulty: " << bot2.difficulty << endl;
			...
			while(gameover == 0)
			{
				...
				while(p1move != true)
				{
					...
					if(bot1.playernumber == 1 || bot2.playernumber == 1)
					{
						...
						{
							coords = bot1.getcoords(size, gameboard1.board); //gets some coords from the bot
						...
						{
							coords = bot2.getcoords(size, gameboard1.board); //gets some coords from the bot
							p1move = gameboard1.makemove(1, coords[0], coords[1]);
						}
					}
